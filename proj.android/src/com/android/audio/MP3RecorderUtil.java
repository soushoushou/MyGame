...
public class MP3RecorderUtil {
	private static final String TAG = MP3RecorderUtil.class.getSimpleName();
	
	static {
		System.out.println("mp3lame");
	}
	...
	public MP3RecorderUtil(int samplingRate, int channelConfig, PCMFormat audioFormat) {
	 ...
	 */
	private String initAudioRecorder() throws IOException {
		String path = "";
		...
		path = path + externalPath + "/AudioRecorder" + "/recording.mp3";
